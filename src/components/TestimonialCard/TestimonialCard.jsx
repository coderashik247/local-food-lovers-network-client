  ...
  return (
    ...
    <div className="text-center mb-3 mt-8">
        ...
        <p className="text-lg text-gray-400 mt-2">
          Hear from our community about their favorite local foods and experiences.
        </p>
      </div>
          ...
          >
            <div className="flex justify-between items-center">
              <div className="flex gap-3 items-center">
                <img src={t.img} alt={t.name} className="w-[60px] h-[60px] rounded-full" />
                <div>
                  <p className="text-[#444] text-[20px] font-bold">{t.name}</p>
                  <p className="text-[#737373] text-sm font-semibold">{t.role}</p>
                </div>
              </div>
              <img src={quote} alt="quote" className="w-8 h-8" />
            </div>
            <p className="text-[#555] text-base">{t.text}</p>
            <Rating style={{ maxWidth: 140 }} value={t.rating} itemStyles={ratingStyle} readOnly />
          </div>
        ))}
